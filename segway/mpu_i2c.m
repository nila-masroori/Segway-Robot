...
j = 1;
a1 = animatedline('Color',[1 0 0 0]); 
a2 = animatedline('Color',[0 1 0 0]);
a3 = animatedline('Color',[0 0 1 0]);

g1 = animatedline('Color',[0 0 0 1]);

legend('Accel_x','Accel_y','Accel_z' , 'gyro_x')
